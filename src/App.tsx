  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center">
      ...
      <div className={`container mx-auto px-4 py-8 w-full ${isMobileView ? 'max-w-md' : 'max-w-7xl'}`}>
        ...
        {/* Input Section */}
        <div className={`bg-white rounded-lg shadow-md mb-6 relative ${isMobileView ? 'p-4 min-h-[140px] flex items-center' : 'p-6'}`}>
          <div className={`${isMobileView ? 'flex w-full' : 'mb-4'}`}>
            <p className={`${isMobileView ? 'text-lg leading-relaxed text-left' : 'text-3xl'} font-normal text-gray-900 flex ${isMobileView ? 'flex-wrap justify-start' : 'flex-wrap'} items-center ${isMobileView ? 'gap-2' : 'gap-3'} transition-all duration-300`}>
